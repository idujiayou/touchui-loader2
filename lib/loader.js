...
module.exports = function (content) {
  ...
  var output = ''
  var parts = parse(content, fileName, this.sourceMap, filePath)
  ...
  if (this.resourcePath.indexOf('app.ui') > -1) {
    fs.utimesSync(path.resolve(path.dirname(this.resourcePath), 'main.js'), new Date(), new Date())
  }
